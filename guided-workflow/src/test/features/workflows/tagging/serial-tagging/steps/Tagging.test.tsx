...
import { TaggingStep } from "~/features/workflows/tagging/serial-tagging/steps/Tagging";
...
describe("TaggingStep Component (Serial Tagging)", () => {
  ...
  it("should handle null tagsets input", () => {
    // Act: Render component with null tagsets
    render(
      <TaggingStep
        tagsets={null}
        selections={[]}
