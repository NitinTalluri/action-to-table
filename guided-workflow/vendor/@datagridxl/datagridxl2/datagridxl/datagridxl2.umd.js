...
!(function (t, e) {
  ...
  var p = function (t, e) {
      for (var i = 0; i < this._rows.store.length; i++) {
        ...
        for (var o = 0; o < this._cols.store.length; o++) {
          ...
          this._cellStore[this._rows.store[i].id - 1][
            this._cols.store[o].id - 1
          ] = { value: t[i][s], _found: !1 };
        }
      }
    },
    f = function (t) {
  ...
  var X = function () {
    ...
    Y = {
      ...
      ".dgxl-contextMenuItem-highlight": function () {
        return {
          "background-color": this.getThemeSetting(
            "contextmenu-item:highlight",
          ),
        };
      },
  ...
  (U.prototype.isOpen = function () {
    ...
    (U.prototype.open = function (t, e, i, o, s, n) {
      ...
      var r =
        ...
        j(
          this._context.getThemeSetting("sheet"),
          "rgba(255,255,255,.35)",
          "rgba(0,0,0,.35)",
        ) +
      ...
      var l =
        "--dgxl-contextmenu-itemheight: " + this.dimensions.itemHeight + "px;";
      ...
      for (
        ...
        var d = "dgxl-contextMenuItem",
          u = "",
          p = !1;
        "disabled" in this.items[c] &&
        this.items[c].disabled.call(this._context)
      ...
      if (this.isOpen())
        for (
          ...
          R(this.items[e].label) &&
            (t.children[e].firstChild.innerHTML =
              this._context.getLocaleSetting(
  ...
  var tt = function () {
      null === this._container
        ...
        : this._container instanceof HTMLElement
          ...
          : (this._domNodes.container = document.getElementById(
              this._container,
            )),
        null === this._container
  ...
  var bt = function (t) {
    for (
      var e = 0, i = 0;
      i < this._cols.coordSections.length && !(i >= t);
      i++
    )
  ...
  var It = function (t) {
    for (
      var e = 0, i = 0;
      i < this._rows.coordSections.length && !(i >= t);
      i++
    )
  ...
  var ve = function (t) {
    ...
    if (
      ("left" == t &&
        (e.push(this._domNodes.rowHeaderColumn),
        (i += this._cd.rowHeaderSpace)),
      "center" == t)
    )
      var o = this._colView;
  ...
  function Ke(t) {
    ...
    for (var i in this.headerLabelSeries)
      e[i] = this.headerLabelSeries[i].indexToLabel(
        t,
        this.headerLabelSeries[i],
      );
    return e;
  }
  function je(t) {
    ...
    if (t in this._listeners && e in this._listeners[t]) {
      ...
      1 == o.length
        ...
        : "debounced" == o[1]
          ...
          : "passive" == o[1] &&
            i.addEventListener(o[0], this._listeners[t][e], { passive: !0 });
    }
  }
  function xi(t, e) {
    if (t in this._listeners && e in this._listeners[t]) {
    ...
    void 0 === t && (t = !1),
      this.constructor._isIOS ||
        ...
        t
          ...
          : setTimeout(function () {
              e._domNodes.cellEditor._isOpen ||
  ...
  var Si = function (t) {
    ...
    Ri = function () {
      ...
      (this.constructor._isMacOS || this.constructor._isIOS) &&
        ...
        (this._domNodes.component.style.width =
          this._cd.containerWidth + "px")),
        (this._isFullscreen = !1),
        vi.call(this),
        setTimeout(function () {
          xi.call(t, "window", "resize"),
            t._domNodes.container._resizeSensor.events.on(
              "resize",
              t._listeners.container.resize,
            );
        }, 100),
      ...
      for (
        ...
        (i = this._viewportPosition.x + e),
          ...
          e == this._colView.length - 1 &&
            (o -= Math.max(this._colViewOverflow, 0)),
          i >= t[0].x &&
            i <= t[1].x &&
            (a.push({ colIndex: i, visibleColIndex: r, visibleColOffset: l }),
            (h += o)),
      ...
      for (
        ...
        (i = this._viewportPosition.y + e),
          ...
          e == this._rowView.length - 1 &&
            (o -= Math.max(this._rowViewOverflow, 0)),
          i >= t[0].y &&
            i <= t[1].y &&
            (a.push({ rowIndex: i, visibleRowIndex: r, visibleRowOffset: l }),
            (h += o)),
  ...
  var ao = function (t, e) {
    ...
    co = function (t) {
      return (
        t.x < this._panesXids.left.length &&
          (t.x = this._panesXids.left.length),
  ...
  function Lo(t) {
    return t.y > this._cd.colHeaderSpace
      ? null
      : { name: "colHeader", coords: wo.call(this, t) };
  }
  function Po(t) {
    if (t.y < 0 || t.y > this._cd.colHeaderSpace) return null;
    for (
  ...
  function To(t) {
    ...
    return i.length
      ? { name: "selectedRowHeader", coords: e, ranges: i }
      : null;
  }
  function Fo(t) {
    return t.x > this._cd.rowHeaderSpace
      ? null
      : { name: "rowHeader", coords: wo.call(this, t) };
  }
  function Eo(t) {
    if (
  ...
  function Oo(t, e) {
    if ((void 0 === t && (t = null), void 0 === e && (e = "mouse"), null == t))
      return null;
    var i,
      o,
      s,
  ...
  function Qo(t) {
    this._domNodes.ghostForFreezeRows.style.transform =
      "translateY(" + t + "px)";
  }
  function Jo(t) {
  ...
  function rs(t) {
    this._domNodes.ghostForFreezeCols.style.transform =
      "translateX(" + t + "px)";
  }
  function ls(t) {
  ...
  function fs(t) {
    this._domNodes.guideForResizeCols.style.transform =
      "translateX(" + t + "px)";
  }
  function gs(t) {
  ...
  function Is(t, e, i) {
    if (
      (void 0 === e && (e = "document"), void 0 === i && (i = null), null == t)
    )
      return null;
    var o = { x: t.x, y: t.y };
  ...
  function Gs(t) {
    for (var e, i = ["next", "prev"], o = 0; o < i.length; o++) {
      ...
      P(
        ...
        null == s
          ? { opacity: 0 }
          : { transform: "translateX(" + s.x + "px)", opacity: e._opacity },
      );
    }
  }
  function Zs(t) {
    for (var e, i = ["next", "prev"], o = 0; o < i.length; o++) {
      ...
      P(
        ...
        null == s
          ? { opacity: 0 }
          : { transform: "translateY(" + s.y + "px)", opacity: e._opacity },
      );
    }
  }
  function $s(t) {
          ...
          "colHeaderEdge" == e.name
            ...
            : e.name.startsWith("freezeLineCol")
              ...
              : e.name.startsWith("freezeLineRow") &&
                qs.call(this, e.objectPosition.y),
          Ks.call(this, e.name));
  }
  function Qs() {
  ...
  var rn = function (t, e, i) {
    ...
    ln = function (t, e, i) {
      this._domNodes.display[t + "EndFunc"] = function (e) {
        Js.call(this, t),
          Hs[t].handler.release.call(
            this,
            this._domNodes.display[t + "Properties"],
          ),
          this._domNodes.display[t + "Flags"].hasMoved &&
            Hs[t].handler.end.call(
              this,
              this._domNodes.display[t + "Properties"],
            ),
  ...
  function mn(t) {
    var e = _o.call(this, t.clientX, t.clientY),
      i = Oo.call(this, e);
    1 == t.detail && (this._domNodes.display._initialMouseHitArea = go(i)),
      null != i &&
        ((i.pointer = "mouse"),
        "jointHeader" == i.name
          ? Xo.call(this, t, i)
  ...
  function Dn() {
    for (
      var t, e, i = Array.prototype.slice.call(arguments), o = [0, 0, 0, 0];
      (e = i.shift());
      ...
      void 0 === e[3] && (e[3] = 1),
        o[3] && e[3]
          ? (((t = [0, 0, 0, 0])[3] = 1 - (1 - e[3]) * (1 - o[3])),
            (t[0] = Math.round(
              (e[0] * e[3]) / t[3] + (o[0] * o[3] * (1 - e[3])) / t[3],
            )),
            (t[1] = Math.round(
              (e[1] * e[3]) / t[3] + (o[1] * o[3] * (1 - e[3])) / t[3],
            )),
            (t[2] = Math.round(
              (e[2] * e[3]) / t[3] + (o[2] * o[3] * (1 - e[3])) / t[3],
            )))
          : (t = e || o),
        (o = t);
    return t;
  ...
  function Xn() {
    ...
    for (var e in this._domNodes.canvas) {
      ...
      for (
        var o = 0;
        o < i._drawHeight && !(o > t[i._panePositionY].length - 1);
        o++
      )
  ...
  var Yn = function (t, e, i, o) {
    ...
    for (
      var s = { left: this._panesXids.left, center: this._colView },
        n = 0,
        r = 0;
      r < s[o].length;
      r++
      ...
      r == s[o].length - 1 && (h += 1);
      var a =
        this._cellStore[i - 1][s[o][r] - 1].color ||
        this.getThemeSetting("sheet");
  ...
  function qn() {
    for (
      var t, e, i = 1 == this._selection.length, o = 0;
      o < this._selection.length;
      o++
    )
    ...
    for (
      ;
      this._domNodes.cellRangeContainer.children.length >
  ...
  var Gn = function (t, e, i, o, s) {
    ...
    Zn = function (t, e, i, o, s) {
      ...
      var r =
          "translate(" + (e.x.offset - 0) + "px," + (e.y.offset - 0) + "px)",
    ...
    $n = function (t, e, i, o, s) {
      ...
      null == e ||
      (i && o) ||
      (s && String(this._currentDragAction).startsWith("select"))
        ? (n.style.opacity = 0)
      ...
      if (null != i) {
        (t.style.opacity = t._opacity || ""),
          ...
          o.x.lineRight && 0 != o.y.size
            ...
            : (t.style["border-right-style"] = "none");
        var n =
          "translate(" + (o.x.offset - 2) + "px," + (o.y.offset - 2) + "px)";
        (t.style.transform = n),
  ...
  function sr() {
    ...
    for (r = 0; r < this._selection.length; r++)
      "col" != this._selection[r].type &&
        (lr.call(this, this._selection[r].range, l), l++);
    for (r = 0; r < e.length; r++) rr.call(this, e[r].range, r);
    for (l = 0, r = 0; r < this._selection.length; r++)
      "row" != this._selection[r].type &&
        (nr.call(this, this._selection[r].range, l), l++);
    for (
      ;
      this._domNodes.colHeaderRangeHighlightContainer.children.length > o;
    ...
    for (
      ;
      this._domNodes.rowHeaderRangeHighlightContainer.children.length > n;
  ...
  function vr() {
    ...
    if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
      ...
      (t.style.transform = "translate(" + s + "px, " + n + "px)"),
        !Jn.call(this, e) ||
        String(this._currentDragAction).startsWith("select")
          ? (t.style.opacity = 0)
  ...
  var Cr = function () {
      if (null != this._prevSelection)
        for (var t, e = 0; e < this._prevSelection.selection.length; e++)
          for (
            var i = 0;
            i < this._prevSelection.selection[e].colIds.length;
            i++
          )
      ...
      (i += this.getColWidthById(this._panesXids.left[e])),
        (s = ar(this._colLines, "position", i)) > -1
          ? (t.splice(t.indexOf(s), 1),
            (this._colLines[s].node.style.opacity = 1))
          : o.push(i);
    i = this._cd.panesX.center.offset;
    for (
      e = 0;
    ...
    for (e = 0; e < this._panesYids.top.length; e++)
      (i += this.getRowHeightById(this._panesYids.top[e])),
        (s = ar(this._rowLines, "position", i)) > -1
          ? (t.splice(t.indexOf(s), 1),
            (this._rowLines[s].node.style.opacity = 1))
          : o.push(i);
    i = this._cd.panesY.center.offset;
    for (
      e = 0;
  ...
  (zr.prototype.on = function (t, e, i, o) {
    ...
    if (
      (Br({ modifierKeys: r, actionKeys: l, characterKeys: h }) &&
        ((s = !0), (n = a.join("+"))),
      s)
    ) {
                  ...
                  if (
                    ...
                    (p =
                      ...
                      this.keysToPrevent[
                        ...
                        delete this.keysToPrevent[
                          this._characterKeys[
                            this.keyActions[h].characterKeys[u]
                          ]
                        ];
                }
      ...
      if (
        ...
        for (var i = 0; i < this.trackedModifierKeys.length; i++) {
          ...
          o in t && 1 == t[o]
            ...
            : o in this.pressedModifierKeys &&
              delete this.pressedModifierKeys[o];
        }
    ...
    Mr = function (t) {
      ...
      if ((void 0 === t && (t = null), document.hasFocus())) {
        for (var i = [], o = 0; o < this.keyActions.length; o++) {
          for (
            var s = 0, n = 0;
            n < this.keyActions[o].modifierKeys.length;
            n++
          )
            this.pressedModifierKeys[
              this._modifierKeys[this.keyActions[o].modifierKeys[n]]
            ] && s++;
          for (n = 0; n < this.keyActions[o].actionKeys.length; n++)
            this.pressedActionKeys[
              this._actionKeys[this.keyActions[o].actionKeys[n]]
            ] && s++;
          for (n = 0; n < this.keyActions[o].characterKeys.length; n++)
            this.pressedCharacterKeys[
              this._characterKeys[this.keyActions[o].characterKeys[n]]
            ] && s++;
          s > 0 &&
            s ==
    ...
    return (
      this.isExecuting ||
        ...
        this.limit &&
          ...
          Yr(this.commands, 0, -(this.limit + 1)),
    ...
    Wr = (function () {
      ...
      function g(t) {
        ...
        if (
          ...
          ("string" != typeof i || n.BAD_DELIMITERS.indexOf(i) > -1) &&
            (i = ","),
          s === i)
        )
        ...
        !0 === s
          ? (s = "#")
          : ("string" != typeof s || n.BAD_DELIMITERS.indexOf(s) > -1) &&
            (s = !1),
          "\n" !== o && "\r" !== o && "\r\n" !== o && (o = "\n");
        var c = 0,
          d = !1;
          ...
          for (
            ...
            if (t[c] !== e)
              if (s && 0 === C.length && t.substring(c, c + y) === s) {
                ...
                if (-1 === L) break;
                if ((C.push(t.substring(c, L)), F(L + _), v && (M(), d)))
                  return E();
      ...
      function _(t) {
        ...
        if (e.error) i.userError(e.error, e.file);
          ...
          var n = {
            abort: function () {
              (s = !0),
                y(e.workerId, { data: [], errors: [], meta: { aborted: !0 } });
            },
            pause: v,
            resume: v,
          };
            ...
            setTimeout(function () {
              if (null != i._cellCursorPosition) {
                ...
                (t.inputField.value = i.getCellValue(i._cellCursorPosition)),
                  (t.inputInfo.textContent = i.getSpreadsheetCoords(
                    i._cellCursorPosition,
                  ));
              }
            }, 0);
          },
        ...
        listeners: {
          ...
          "inputField.focus": function (t, e) {
            t.inputWrapper.classList.add("dgxl-hasFocus"),
              P(
                t.inputWrapper,
                Y[".dgxl-inputWrapper.dgxl-hasFocus"].call(this),
              );
          },
  ...
  function hl(t) {
    return null == t
      ? null
      : [
          Is.call(this, { x: t[0].x, y: t[0].y }),
          Is.call(this, { x: t[1].x, y: t[1].y }),
        ];
  }
  function al(t) {
    for (var e = [], i = 0; i < t.length; i++)
  ...
  function ul(t, e, i, o) {
    ...
    for (var c = 0; c < a.length; c++) {
      for (var d = n.length, u = 0; u < a[c].rowIds.length; u++)
        n.indexOf(a[c].rowIds[u]) > -1
          ? "rowStartIndex" in a[c] ||
            (a[c].rowStartIndex = n.indexOf(a[c].rowIds[u]))
          : n.push(a[c].rowIds[u]);
    ...
    for (c = 0; c < a.length; c++) {
      ...
      for (u = 0; u < a[c].colIds.length; u++)
        s.indexOf(a[c].colIds[u]) > -1
          ? "colStartIndex" in a[c] ||
            (a[c].colStartIndex = s.indexOf(a[c].colIds[u]))
          : s.push(a[c].colIds[u]);
    ...
    var x = [];
    for (c = 0; c < a.length; c++)
      ("action" in a[c] && "cut" == a[c].action) ||
        x.push({ range: a[c].range, type: "cell" });
    return { rowIds: n, colIds: s, values: r, selection: x };
  }
  var pl = function (t) {
      for (
        var e, i = this._cols.store._lastId, o = [], s = t[0].x;
        s <= t[1].x;
        s++
      )
    ...
    fl = function (t) {
      for (
        var e, i = this._rows.store._lastId, o = [], s = t[0].y;
        s <= t[1].y;
        s++
      )
  ...
  function ml(t, e) {
    for (var i = [], o = this._rows.store._lastId, s = 0; s < t; s++)
      o++,
        this._rows.store.push({ id: o, title: void 0, _pass: !0 }),
        i.push(o);
  ...
  function Rl(t, e) {
    if ((void 0 === t && (t = null), void 0 === e && (e = "xy"), null == t))
      return { x: 0, y: 0 };
  ...
  function kl() {
    (this._domNodes.component.style.width = this._cd.componentWidth + "px"),
      ...
      (this._domNodes["pane-left"].style.height =
        this._cd.viewportHeight + "px"),
      ...
      (this._domNodes.hintsContainer.style.width =
        this._cd.viewportWidth + "px"),
  ...
  var Hl = function () {
    ...
    Tl = function () {
      (this._domNodes.gridLines.style.width = this._cd.viewportWidth + "px"),
        (this._domNodes.gridLines.style.height =
          this._cd.viewportHeight + "px"),
    ...
    Fl = function () {
      (this._domNodes.backgrounds.style.height =
        this._cd.viewportHeight + "px"),
        (this._domNodes.backgrounds.style.width =
          this._cd.viewportWidth + "px"),
    ...
    Bl = function () {
      (this._domNodes.freezeLines.style.height =
        this._cd.viewportHeight + "px"),
    ...
    if ((t = t.toLowerCase())) {
      for (var o = 0; o < this._rows.coordList.length; o++)
        for (var s = 0; s < this._cols.coordList.length; s++) {
          var n =
            this._cellStore[this._rows.coordList[o] - 1][
  ...
  function Dl(t) {
    var e = this;
    if (
      (void 0 === t && (t = ""), w.call(this), x.call(this), t.endsWith("Cols"))
    )
    ...
    for (i = 0; i < this._validatedBottomBar.length; i++)
      "update" in this._validatedBottomBar[i] &&
        this._validatedBottomBar[i].update.call(
          this,
          this._bottomBarNodes[i].nodes,
        );
    setTimeout(function () {
      $s.call(e);
    }, 0);
        ...
        if (
          ...
          Nl.call(this),
            "do" == t
              ...
              : "undo" == t
                ? (r.length && (h = xl.call(this, r)),
                  l.length && (a = wl.call(this, l)))
                : "redo" == t &&
              ...
              if (null != s)
                do {
                  ...
                  for (var l = [], h = 0; h < o.length; h++)
                    l.push(
                      this._cellStore[e.rowIds[c] - 1][o[h] - 1].value || null,
                    );
                  n.push(l), c++;
                } while (
                  c <= e.rowIds.length - 1 &&
                  performance.now() - t < 25
                );
              else
                do {
  ...
  function Kl(t, e, i) {
    ...
    var o = this.getCellRangeData(t),
      n = [];
    if ("right" == e)
      for (var r = 0; r < o.length; r++) n.push({ series: o[r] });
    else if ("left" == e)
      for (r = 0; r < o.length; r++) n.push({ series: o[r].reverse() });
    else if ("down" == e)
  ...
  function Ul(t) {
    ...
    for (var s = [], n = 0; n < o.length; n++)
      s.push({ range: ir.call(this, o[n]), type: "col" });
    return s;
  }
  function ql(t) {
    var e = this;
    ...
    for (
      var i = al.call(this, Ul.call(this, t)), o = new Set(), s = 0;
      s < i.length;
      s++
    )
      for (
  ...
  function ih(t, e) {
    ...
    for (s = 0; s < o.length; s++)
      o[s] == i + 1 || 0 == s ? r.push(o[s]) : (n.push(r), (r = [o[s]])),
        (i = o[s]);
    return n.push(r), n;
  }
  function oh(t) {
    ...
    if ((void 0 === t && (t = null), null != t)) {
      for (var e = ql.call(this, t), i = [], o = 0; o < e.length; o++) {
        for (var s, n = 0, r = 0; r < this._rows.coordList.length; r++)
          if (
            null !=
            (s = this._cellStore[this.getRowIdByCoord(r) - 1][e[o] - 1].value)
          ) {
  ...
  function Ph(t) {
    ...
    i(t) ? (o = t) : e(t) ? (o = [t]) : d(t) && (o = [[t, t]]);
    for (var s = [], n = 0; n < o.length; n++)
      s.push({ range: or.call(this, o[n]), type: "row" });
    return s;
  }
  function Nh(t) {
    var e = this;
    if ((void 0 === t && (t = null), null == t)) return [];
    for (
      var i = al.call(this, Ph.call(this, t)), o = new Set(), s = 0;
      s < i.length;
      s++
    )
      for (
    ...
    for (
      ...
      if (this._rows.store[this._rows.indexList[e] - 1]._hide)
        ...
        for (var n = [], r = 0; r < t.length; r++)
          null ===
            (i =
              this._cellStore[this._rows.indexList[e] - 1][t[r][0] - 1]
                .value) && (i = ""),
            n.push(String(i));
  ...
  function ma(t) {
    return null == this._cols.store[t - 1]
      ? null
      : this._cols.store[t - 1].width;
  }
  function xa(t) {
  ...
  function Oa() {
    var t = this.getColPositionInViewport(this._cellCursorPosition.x),
      ...
      i = 0,
      o = this.getRowHeightById(
        this._rows.coordList[this._cellCursorPosition.y],
      ),
  ...
  function Da(t) {
    ...
    for (var e = "", i = 0; i < this._rows.coordList.length; i++) {
      for (var o = 0; o < this._cols.coordList.length; o++) {
        var s = this.getCellFromStore(
          this._rows.coordList[i],
          this._cols.coordList[o],
        ).value;
        (e += null == s ? "" : s),
  ...
  function $a(t) {
    return (
      this.headerLabelSeries.letters.indexToLabel(
        this.getColIndexByCoord(t.x),
      ) +
  ...
  function ic() {
    ...
    Xt.call(this),
      ...
      this._isFullscreen &&
      i == this._cd.componentWidth &&
      e > this._cd.componentHeight + 200
        ? (o = !0)
        : this._isFullscreen &&
          i == this._cd.componentWidth &&
    ...
    if ((void 0 === t && (t = null), null != t)) {
      ...
      if (1 == this._selection.length && Di.call(this, e)) {
        ...
        o > e[1].x
          ? ((n.right = !0),
            (o = e[0].x),
            s < e[1].y ? s++ : ((s = e[0].y), (n.bottom = !0)))
          : o < e[0].x &&
            ((n.left = !0),
            (o = e[1].x),
            s > e[0].y ? s-- : ((s = e[1].y), (n.top = !0))),
          s > e[1].y
            ? ((n.bottom = !0),
              (s = e[0].y),
              o < e[1].x ? o++ : ((o = e[0].x), (n.right = !0)))
            : s < e[0].y &&
              ((n.top = !0),
              (s = e[1].y),
              o > e[0].x ? o-- : ((o = e[1].x), (n.left = !0)));
        var r = { x: o, y: s },
  ...
  function Kc() {
    this.undoManager.hasUndo() &&
      (this.undoManager.undo(), (this._isUndo = !0));
  }
  function jc() {
    this.undoManager.hasRedo() &&
      (this.undoManager.redo(), (this._isRedo = !0));
  }
  function Uc() {
  ...
  function Zc() {
    if (!("_isDestroyed" in this)) {
      ...
      for (var e in this.constructor._domNodes)
        this.constructor._domNodes[e].remove(),
          delete this.constructor._domNodes[e];
      this._isDestroyed = !0;
    }
  }
  var $c = function (t, e) {
