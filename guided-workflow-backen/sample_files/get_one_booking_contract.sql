...
call get_one_booking_contract('alanzen@cisco.com',94, 123456)
use schema CPS_DSCI_API;
use schema CPS_DSCI_BR;
create or replace  procedure get_one_booking_contract(logged_user varchar, dc_engagement_id integer, booking_contract integer)
	...
	as $$
        ...
        res RESULTSET default ( with booking as (
                        ...
                        from dc_BOOKINGS_CONTRACTS c
                            ...
                            where eru.dc_engagement_id= :dc_engagement_id and c.BOOKING_CONTRACT = :booking_contract and
                            c.IS_DELETED = 'F' and eru.is_deleted ='F'  and ru.is_deleted ='F' and u.IS_DELETED = 'F'
                    ), contracts as (
